...
GRAPHICS_SRC    := graphics/Renderer.cpp graphics/TextSystem.cpp graphics/ParticleSystem.cpp graphics/AnimationSystem.cpp graphics/MenuSystem.cpp graphics/RaylibColors.cpp graphics/PostProcessingSystem.cpp
